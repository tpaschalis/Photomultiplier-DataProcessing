...
def AdditionalBranches():
	...
	# for i in xrange(30000):
		...
		for u in xrange(points_per_event):
			EventData.append(rundata[(i+30000)*points_per_event+u])
...
# This is used in AdditionalBranches func. DOn't delete unless necesarry.
# rundata = None
# del rundata
